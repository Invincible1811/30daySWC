...
const moreMenuItems: { icon: React.ElementType; label: string; page: Page }[] = [
  ...
  { icon: CalendarDays, label: "Events", page: "events" },
  { icon: Users, label: "Groups & Outreach Teams", page: "groups" },
  { icon: Globe, label: "Community", page: "community" },
  { icon: Wrench, label: "Soul-Winning Toolkit", page: "toolkit" },
  { icon: Trophy, label: "Global Impact Board", page: "leaderboard" },
